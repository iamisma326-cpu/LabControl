<?php
// Página de "Mi cuenta" del Docente. Archivo autónomo e independiente del Alumno.
...
$portal_nombre = 'Portal del Docente';
$sustantivo    = 'Docente';
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-9 space-y-8">
                    ...
                    <section id="perfil" class="panel-cristal p-6 sm:p-8 space-y-6 <?php if ($tab != 'perfil') { echo 'hidden'; } ?>">
                        ...
                        <?php
                        if (isset($usuario['nombres'])) { $val_nombres = $usuario['nombres']; } else { $val_nombres = ''; }
                        if (isset($usuario['apellidos'])) { $val_apellidos = $usuario['apellidos']; } else { $val_apellidos = ''; }
                        if (isset($usuario['dni'])) { $val_dni = $usuario['dni']; } else { $val_dni = ''; }
                        if (isset($usuario['correo'])) { $val_correo = $usuario['correo']; } else { $val_correo = ''; }
                        if (isset($usuario['telefono'])) { $val_telefono = $usuario['telefono']; } else { $val_telefono = ''; }
                        ?>
                                ...
                                <div class="flex-grow space-y-4 w-full">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div class="space-y-2">
                                            ...
                                            <input type="text" id="nombres" name="nombres" class="campo-form-alumno" value="<?php echo $val_nombres; ?>">
                                        </div>
                                        <div class="space-y-2">
                                            <label class="etiqueta-form-alumno" for="apellidos">Apellidos</label>
                                            <input type="text" id="apellidos" name="apellidos" class="campo-form-alumno" value="<?php echo $val_apellidos; ?>">
                                        </div>
                                    </div>

                                    <div class="space-y-2">
                                        <label class="etiqueta-form-alumno" for="dni">DNI</label>
                                        <input type="text" id="dni" name="dni" class="campo-form-alumno" value="<?php echo $val_dni; ?>" readonly>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="email" id="correo" name="correo" class="campo-form-alumno" value="<?php echo $val_correo; ?>" readonly>
                                    </div>

                                    <div class="space-y-2">
                                        <label class="etiqueta-form-alumno" for="telefono">Teléfono</label>
                                        <input type="tel" id="telefono" name="telefono" class="campo-form-alumno" value="<?php echo $val_telefono; ?>">
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Seguridad y acceso -->
                    <section id="seguridad" class="panel-cristal p-6 sm:p-8 space-y-6 <?php if ($tab != 'seguridad') { echo 'hidden'; } ?>">
                        <div class="border-b border-neutral-900/60 pb-3 flex items-center gap-2">
