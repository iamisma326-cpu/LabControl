<?php
// Pantalla de login del jefe de soporte. Es 100% independiente, sin includes visuales.

// Configuración propia de este login (antes vivía en _login_config.php compartido).
$cfg = [
    'badge'             => 'ADM',
    'badge_color'       => 'rose',
    'titulo'            => 'Portal de Soporte',
    'descripcion'       => 'Ingresa tus credenciales para acceder al sistema de gestión.',
    'campo_label'       => 'DNI',
    'campo_nombre'      => 'dni',
    'campo_icono'       => 'user',
    'campo_placeholder' => '12345678',
    'campo_pattern'     => '[0-9]{8}',
    'campo_title'       => 'Ingrese un DNI válido (8 dígitos)',
    'submit_texto'      => 'Acceder al Sistema',
    'submit_color'      => 'rose',
    'separador'         => 'Sistema de Soporte',
    'pie'               => '[ ACCESO SEGURO ACTIVADO ]',
    'destino'           => 'modulos/soporte/dashboard_jefe_soporte.php',
